...
def main():
    ...
    parser.add_argument('--script', type=str, default='lmtrack', help='Name of the train script.')
    # parser.add_argument('--config', type=str, default='vitb_256_mae_32x4_ep100', help="Name of the config file.")
    parser.add_argument('--config', type=str, default='vitb_256_mae_32x4_ep100', help="Name of the config file.")
