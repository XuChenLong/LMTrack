            ...
            if is_video_dataset:
                ...
                if self.frame_sample_mode == 'causal':
                    ...
                    while search_frame_ids is None:
                        template_frame_ids = self._sample_visible_ids(visible, num_ids=1, min_id=self.num_template_frames - 1,
                        ...
                        search_frame_ids = self._sample_visible_ids(visible, min_id=template_frame_ids[-1] + 1,
