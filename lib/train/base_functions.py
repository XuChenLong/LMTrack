...
def get_optimizer_scheduler(net, cfg):
    ...
    if train_cls:
        ...
        param_dicts = [
            {"params": [p for n, p in net.named_parameters() if "backbone" not in n or "mask_decoder" in n and p.requires_grad]},
            {
                "params": [p for n, p in net.named_parameters() if "backbone" in n and "mask_decoder" not in n and p.requires_grad],
