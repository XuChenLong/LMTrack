...
def main():
    ...
    parser.add_argument('tracker_param', default='baseline_fullx4_384', type=str, help='Name of config file.')
    ...
    # parser.add_argument('--sequence', type=str, default='GOT-10k_Test_000006', help='Sequence number or name.')
